...
const navigation = [
  ...
  { name: 'Apps', href: '/apps', icon: FolderIcon, current: true },
...
const AppsModule = () => {
  ...
  const filteredApps = appPackages.filter(app =>
    ...
    app.appDesc?.toLowerCase().includes(searchQuery.toLowerCase())
  );
            ...
            {!loading && !error && (
              <>
                <div className="mb-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                      {filteredApps.length} app{filteredApps.length !== 1 ? 's' : ''} {searchQuery ? 'found' : 'available'}
                    </p>
                  </div>
                  <button className="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-500">
                ...
                {filteredApps.length === 0 ? (
                  <div className="rounded-2xl border border-indigo-100 bg-white p-12 text-center dark:border-indigo-300/20 dark:bg-gray-900/80">
                    <FolderIcon className="mx-auto size-12 text-gray-400 dark:text-gray-500" />
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                      {searchQuery 
                        ...
                        : 'Get started by creating your first low-code application.'}
                    </p>
                    {!searchQuery && (
                      <button className="mt-6 inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-500">
                        Create New App
                      </button>
                    )}
                  </div>
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{app.appName}</h2>
                            {app.appDesc && (
